            ...
            <div class="row justify-content-end">
                <div class="">
                    <form action="" method="post">
                            <button type="submit" class="btn btn-danger mx-3" data-toggle="modal" data-target="#cambiarPass">
                                Remover acceso
                            </button>
                        </form>
                    <!-- <form action="" method="post">
                        <button type="submit" class="btn btn-primary mx-3" data-toggle="modal" data-target="#cambiarPass">
                            Permitir acceso
                        </button>
                    </form> -->
                </div>
